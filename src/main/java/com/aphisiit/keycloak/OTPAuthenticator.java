...
import org.keycloak.credential.CredentialProvider;
  ...
  * @version $Revision: 1 $
  */
 public class OTPAuthenticator extends AbstractDirectGrantAuthenticator implements CredentialValidator<OTPCredentialProvider> {
     ...
     public void authenticate(AuthenticationFlowContext context) {
        ...
        //  String credentialId = otpCredentialModel.getId();
         ...
         if (otp == null) {
             ...
             context.getEvent().error(Errors.INVALID_USER_CREDENTIALS);
            //  Response challengeResponse = errorResponse(Response.Status.UNAUTHORIZED.getStatusCode(), "invalid_grant", "Invalid user credentials");
            Response challengeResponse = Response.status(Response.Status.UNAUTHORIZED.getStatusCode()) 
